...
different categories (Fig. 3). Using these match accuracies, we first asked
...
difficult than others. The results are shown in Fig. 4A. Performance
...
imitation (True seed questions; see Fig. 3). That is, the advantage of having the
...
(Fig. 4B). This was true for True seed questions containing
...
`r lmer_mod_results(lsn_after_first_block_lmertest_mod, "message_c")` (Fig. 5A).
...
(Fig. 5B). This result suggests that transcriptions from later generation
imitations were easier to generalize to new category members.

```{r fig5, fig.width=6, fig.height=3.5, fig.cap="Repeated imitations made for better category labels. A. Mean RTs for correct responses in the category learning experiment with ±1 SE. B. Cost of generalizing to new category members with ±1 SE."}
grid.arrange(
  rt_plot +
    ggtitle("A"),
  gg_transition +
