...
## Iterated imitations were easier to learn as category labels
...
[^below]: We noticed that performance on some Specific match questions dropped significantly _below_ chance. We were unable to account for this "aversion" to the correct answer. For example, it was not the case that responses to these low performance questions were always converging on a single but incorrect answer.
