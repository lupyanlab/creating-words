...
```{r fig3, fig.height=10, out.height="10cm", fig.cap="(Top) RTs on correct trials by block, showing faster responses when learning category labels transcribed from last generation imitations. (Bottom) RTs on trials leading up to and immediately following the block transition where new category members are introduced."}
...
grid.arrange(
  arrangeGrob(q_true_seed, q_category_match, q_specific_match, ncol = 1,
              top = textGrob("A. Types of matching questions", hjust = 1.2, gp=gpar(fontsize=16))),
  gg_match_to_seed, # + horizontal_margin,
  gg_match_transcriptions, # + horizontal_margin,
  ncol = 1,
