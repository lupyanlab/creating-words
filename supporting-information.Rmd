...
We also had participants "transcribe" the seed sounds directly.
...
```{r}
# accuracy in matching transcriptions of seed sounds
```
...
```{r}
# performance for learning transcriptions of seed sounds
```
