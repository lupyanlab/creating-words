...
seed sounds are analyzed in the Supplementary Materials (Fig. S5).
...
environmental sound cues are reported in the Supplementary Materials (Fig. S5).
...
```{r fig3, fig.cap="Orthographic distance between the most frequent transcription and all other transcriptions of a given imitation. Error bars denote ±1 SE of the hierarchical linear model predictions."}
gg_distance
```
