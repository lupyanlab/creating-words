...
A brief summary of our results is as follows. Measuring the acoustic similarity of repeated imitations revealed that imitations became more similar to one another over generations of repetition. As the imitations were repeated, they were more difficult to match back to the original sounds, but within-category information was lost more readily than between-category information, suggesting that the imitations were becoming more categorical through repetition. We performed the same analyses on transcriptions of the imitations, and found similar results. Transcription agreement increased over generations of imitation, supporting our hypotheses that the imitations were stabilizing through repetition. Also, transcriptions of even last generation imitations were able to be matched back to the category of environmental sounds that produced them. When transcriptions of first and last generation imitations were learned as novel category labels, last generation transcriptions were easier to learn than first generation transcriptions. These results describe a process by which an imitation of an environmental sound may transition to a more word-like and categorical form through unguided repetition.
...
Were the imitations stabilizing on arbitrary acoustic forms or were they capturing some aspect of the original environmental sound? To test this, we measured the ability of participants naive to the design of the Telephone game to match each imitation back to its original seed source ("Guess the seed") relative to other seed sounds from the same category or from different categories. All `r n_final_imitations` imitations were tested in the three conditions depicted in Fig. 3. These conditions differed in the relationship between the imitation and the four seed sounds serving as the choices in the 4 alternative forced choice task.
...
We next tested whether the imitations were stabilizing on particular words as opposed to non-linguistic, i.e., non-English sounds by having participants transcribe the imitations into English orthography and measuring whether transcription agreement increased over generations. We selected the first and final three imitations in each transmission chain to be transcribed. `r n_transcribers` generated a total of `r n_transcriptions` or `r n_transcriptions_per_imitation` transcriptions per imitation. Transcriptions containing actual English words were excluded from analysis (`n_transcriptions_dropped`).

```{r table1, results='asis'}
kable(transcription_examples, format='latex', booktabs=TRUE)
```

To measure transcription agreement we took the average orthographic distance (`name of algorithm`) between the most frequent transcription and all other transcriptions of a given imitation. Transcriptions of later generation imitations were more similar to one another in terms of orthographic distance than transcriptions from earlier generations, `r lmer_mod_results(orthographic_distance_lmertest_mod, "message_c")` (Fig. 5). This result supports our hypothesis that unguided repetition stabilizes imitations on a particular word.
...
Participants were able to accurately guess the source of an imitation after 8 repetitions, but what about the source of a transcription of an imitation? Do these invented words still resemble the category of sounds that was originally imitated? We tested the top 4 most frequent transcriptions for each imitation in a modified version of the "Guess the Seed" game (see Fig. 3). Participants were given a novel word and had to guess which sound they thought the person who invented the word was talking about. For this experiment we tested True seed and Category match questions only, excluding Specific match questions because matching accuracy of imitations had already dropped to chance levels.
...
Our hypothesis was that repetition of imitations would result in more and more word-like forms, but what are the consequences of this transition from the perspective of a language user? We tested whether the words created through repetition were easier to learn as category labels.
