...
crotchet::draw_image("collect-imitations-gui", "wordsintransision")
```
...
crotchet::draw_image("monitor-imitations", "wordsintransition")
```
...
crotchet::draw_image("transcribe-imitations-gui", "wordsintransition")
```
...
crotchet::draw_image("match-imitations-gui", "wordsintransition")
```

```{r fig14, fig.cap="Interface for matching transcriptions back to original seed sounds."}
crotchet::draw_image("match-transcriptions-gui", "wordsintransition")
```
