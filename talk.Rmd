...
```{r dimension, engine="dot"}
digraph {
  rankdir=LR;
  node[fontname=Helvetica shape=none imagescale=true];
  left -> gary -> right[style=invis];
  left, right[style=invis]
  
  gary[label="" image="img/gary.jpg"];
  gary -> {iconic, arbitrary}[constraint=false];
  ...
  iconic[label="" image="img/marcus.png"];
  arbitrary[label="" image="img/pierce.jpg"];
