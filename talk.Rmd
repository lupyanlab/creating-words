...
```{r plato}
crotchet::draw_image("img/plato.jpg")
```

# Onomatopoeic words are found across languages

```{r onomatopoeia-comics}
...
# Why is onomatopoeia important to language evolution?

- Maybe languages began with words everyone could agree on.

# Are humans poor vocal imitators?
