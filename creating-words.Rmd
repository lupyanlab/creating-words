...
```{r fig1, fig.cap="The design of the transmission chain experiment. Seed sounds (16) were sampled from four categories of environmental sounds: glass, tear, water, zipper. Participants imitated each seed sound, and then the next generation of participants imitated the imitations, and so on, for up to 8 generations. Chains are unbalanced due to random assignment and the exclusion of some low quality recordings."}
gg_dendrogram
```
...
Transcriptions of imitations were collected from participants (_N_=`r n_transcribers`) recruited from Amazon Mechanical Turk. Participants listened to imitations and were instructed to write down what they heard as a single word so that the written word would sound as much like the message as possible. Transcriptions were gathered for the first and the last three generations of all imitations collected in the transmission chain experiment; that is, not all imitations were transcribed. Participants also provided "transcriptions" of the original environmental seed sounds (Fig. S6). Transcriptions from participants who failed a catch trial were excluded (_N_=`r n_bad_transcribers`), leaving `r n_transcriptions` transcriptions for analysis, or approximately `r n_transcriptions_per_imitation` transcriptions per imitation. Of these, `r n_english_transcriptions` transcriptions (8%) were removed because they contained English words, which was a violation of the instructions of the experiment. Our primary measure of transcription distance was provided by the `SequenceMatcher` functions in the `difflib` package of the Python standard library which implements a version of Ratcliff and Obershelp's "gestalt pattern matching" algorithm.
...
The possibility that the increase in acoustic similarity was due to transmission chains converging on similar acoustic forms through continuous degradation of the signal was ruled out by additional analyses of acoustic similarity using MFCCs. These analyses compared acoustic similarity for pairs of sounds sampled from the same and from different transmission chains. To test whether acoustic similarity was always greater within chains than between them, we fit a linear model predicting MFCC similarity from the type of pairwise comparison coded with Helmert contrasts. The results revealed that acoustic similarity was the highest along consecutive generations of transmission chains (1), followed by all within-chain comparisons (2), all within-seed comparisons (3), all within-category comparisons (4), with imitations from different categories (5-6) being the least similar to one another (Fig. S2). The ordering of these acoustic similarity measures supports the conclusion that transmission chains were stabilizing on divergent acoustic forms as opposed to the observed increase in acoustic similarity resulting from continuous degradation.
...
Repeating imitations of environmental sounds over generations of unique speakers was sufficient to create more wordlike forms. We defined wordlike-ness in two ways: acoustic stability, and orthographic agreement. By both measures, repeated imitations became more wordlike through repetition. With additional repetitions, the imitations became more similar to one another, and easier to repeat with higher fidelity---a requirement for integrating a new word into a language. In addition, later generation imitations were also easier to transcribe into English orthography, further supporting our hypothesis that repeating imitations were stabilizing on particular word forms.

Although the results of Experiment 1 demonstrated the ease with which repeated imitation can give rise to unique word forms, they leave open the question of whether these unique word forms are in any way advantageous from the perspective of language learners. Is there anything different about words invented through repeated imitation as compared to "words" coined from direct imitations of environmental sounds? In Experiment 2, we answer this question by comparing the two types of words in a category learning experiment.
...
Our transmission chain design and subsequent transcription procedure created `r n_created_words` unique words. From these, we sampled words transcribed from first and last generation imitations, as well as "transcriptions" of seed sounds. Our procedure for sampling transcriptions to use as category labels was as follows. First, we removed transcriptions that contained less than 3 unique characters and transcriptions that were over 10 characters long. Of the remaining transcriptions, a sample of `r n_lsn_words` were selected that were approximately equally associated with the target category. To measure the association between each imitation and its target category (the category of the seed sound), we used a 4AFC procedure described in Experiment 3. The purpose of this measure of association strength in selecting words to learn as category labels was to select words transcribed from first and last generation imitations that were initially equally associated with the target categories. Equating along this dimension allowed for a more focused test of differences between the words in terms of generalization to new category members. The final sample of transcriptions were selected using a bootstrapping procedure which involved selecting a desired mean (the average matching accuracy for eligible transcriptions of last generation imitations) and sampling transcriptions from first generation imitations until the match accuracy of those imitations matched the desired mean within 1 SD.
