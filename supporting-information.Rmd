...
categories. Having 4 sounds in 4 categories was necessary in order to generate 4AFC questions with both between-category and within-category distractors with the appropriate level of counterbalancing across all conditions.
...
caption <- "Environmental sounds used as \"seed messages\"."
...
Participants played a version of the children's game of Telephone via an online interface (Fig. S3). Initially the only action open to players is to hear the message by clicking the top sound icon. After listening to the message once, they could then initiate a recording of their imitation by clicking the bottom sound icon to turn the recorder on. Turning the recorder off submitted their response. If the recording was too quiet (less than -30 dBFS), participants were asked to repeat their imitation. In response, they could repeat the initial message again. After a successful recording was submitted a new message was loaded. Participants made 4 recordings each.
...
```{r 4-transcribe-imitations-gui, fig.width=3, fig.height=3, fig.cap="Interface for collecting transcriptions. Participants were instructed to create novel English words corresponding to the sound they heard."}
...
```{r 4-match-transcriptions-gui, fig.width=3, fig.height=3, fig.cap="Interface for matching transcriptions back to original seed sounds."}
