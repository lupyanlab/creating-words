...
transmission chain. Additional "transcriptions" directly of the original
environmental seed sounds were also collected and are analyzed in the
...
than first generation imitations. We collected approximately
`r n_transcriptions_per_imitation` transcriptions per sound. Some examples of
the transcriptions are presented in Table 1.
...
gives rise to stable wordforms. However, the results do not address how these
