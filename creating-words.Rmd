...
[e.g., @Pagel:2007br]. At least in part as a consequence of this divergence,
...
in similarity between generations could be detected after fewer
repetitions, in around 5 generations. Imitations from chains that did not
reach 5 generations due to experimental constraints (see Fig. 1) were included
in all analyses, which included appropriate random effects to assure that these
shorter chains were not treated equally to longer chains. However, chains with
